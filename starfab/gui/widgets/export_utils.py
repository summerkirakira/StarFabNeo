...
class ExportOptionsWidget(StarFabStaticWidget):
    ...
    def reset_from_settings(self):
        ...
        self.opt_overwriteExisting.setChecked(strtobool(
            self.starfab.settings.value(f'{SETTINGS_PATH}/overwrite_existing', 'false')
        ))
